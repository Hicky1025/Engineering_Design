    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departments', models.ManyToManyField(blank=True, help_text='Specific Departments for this user.', related_name='user_set', related_query_name='user', to='accounts.department', verbose_name='所属')),
